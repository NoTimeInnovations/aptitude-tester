    ...
    <>
      <div className="bg-[rgba(153,187,221,100)] min-h-screen p-3 md:p-12 md:pl-32 pt-20">
        <div className="bg-white text-[rgba(0,0,0,100)] w-full md:w-6xl h-auto md:h-40 rounded-2xl font-['Poppins'] text-.5xl md:text-5xl pl-6 md:pl-12 pt-6 pb-8 md:pb-0 md:pt-10 font-semibold relative">
          ...
          <div className="text-xs md:text-2xl font-extralight absolute top-[25%] md:top-[25%] left-[80%] md:left-[70%] transform -translate-x-1/2 md:translate-x-0 w-[50%] md:w-96 text-left">
        ...
        <div className="bg-white flex flex-col w-full md:w-[1400px] mt-12 md:mt-36 p-6 md:p-36 rounded-2xl items-center">
          ...
          <button
            ...
            className="bg-[rgba(4,2,105,100)] rounded-md mt-8 md:mt-20 h-10 w-full md:w-1/5 px-4"
          >
            <span className="text-white text-[18px] font-['Poppins']">
              Start
            </span>
          </button>
          <button className="bg-[rgba(0,0,0,100)] rounded-md mt-4 md:mt-8 h-10 w-full md:w-1/5 px-4">
            <span className="text-white text-[18px] font-['Poppins']">
              Exit
            </span>
          </button>
